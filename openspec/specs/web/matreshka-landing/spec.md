# web/matreshka-landing Specification
...
#### Scenario: Page sections follow the marketing order

- **WHEN** a visitor loads the landing
- **THEN** the page shows header, hero, Matrena score banner, product window, alternating feature blocks, and a three-card row, with no trusted-by logo strip
