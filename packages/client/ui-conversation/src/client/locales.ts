...
export const zh = {
  ...
  'tool.title.generateImage': '生成图片',
  'tool.title.editImage': '编辑图片',
  'image.generating': '正在生成图片…',
  'image.editing': '正在编辑图片…',
...
export const en = {
  ...
  'audio.label': 'Play {name}',
  'audio.loading': 'Loading audio…',
  'audio.failed': 'This audio cannot be played',
  ...
  'hero.headline': 'What should we do?',
  'hero.preview': 'Alpha',
  ...
  'tool.title.generateImage': 'Generate image',
  'tool.title.editImage': 'Edit image',
...
export const ru = {
  ...
  'hint.goal.active': 'цель выполняется — edit / pause / resume / clear',
  ...
  'input.commands': 'Добавить файлы или вызвать команды',
  'input.file': 'Файл',
  'input.stop': 'Остановить генерацию',
  'input.send': 'Отправить сообщение',
  'input.send.queue': 'В очередь',
  'input.send.steer': 'Перебить',
  'audio.label': 'Слушать {name}',
  'audio.loading': 'Загрузка аудио…',
  'audio.failed': 'Не удалось воспроизвести аудио',
  'attachment.pending': 'Вложения к отправке',
  ...
  'attachment.dropDesc': 'Лимит изображений: до {count} шт., каждое до {size}',
  ...
  'image.copy': 'Копировать',
  'image.share': 'Поделиться',
  'image.folder': 'Папка',
  'image.copyPath': 'Копировать путь',
  'image.savedIn': 'Сохранено в {path}',
  'image.prev': 'Предыдущая',
  ...
  'image.totalTooLarge': 'Суммарный размер изображений больше {size}; удалите часть и повторите',
  'image.tooManyPixels': 'Слишком большое разрешение; сожмите изображение и повторите',
  'image.dimensionTooLarge': 'Сторона изображения не больше {size}px; уменьшите и повторите',
  ...
  'settings.enter.title': 'Отправка, пока агент занят',
  'settings.enter.description': 'Что делают Enter и кнопка «Отправить», пока агент выполняется; Cmd/Ctrl+Enter — другое действие',
  'settings.enter.queue': 'В очередь',
  'settings.enter.steer': 'Перебить',
  'hero.headline': 'Что сделаем?',
  'hero.preview': 'Альфа',
  'hero.chooseWorkspace': 'Выберите рабочую область',
  ...
  'tool.title.generateImage': 'Генерация картинки',
  'tool.title.editImage': 'Правка картинки',
  'image.generating': 'Генерируем картинку…',
  'image.editing': 'Правим картинку…',
  'tool.title.grep': 'Grep',
  'tool.title.glob': 'Glob',
  'tool.title.webSearch': 'Поиск',
  'tool.title.webFetch': 'Загрузка',
  'tool.autoReviewRejected': 'Отклонено Auto review',
  'tool.autoReviewNotExecuted': 'Инструмент не выполнен. Причина: {reason}',
  'tool.autoReviewReasonFallback': 'Auto review не разрешил это действие',
  ...
  'queue.edit.unsupported': 'Содержит нетекстовое содержимое; правки пока нет',
  'queue.save': 'Сохранить сообщение в очереди',
  'queue.cancelEdit': 'Отменить правку',
  'queue.remove': 'Удалить сообщение из очереди',
  'queue.steer': 'Перебить сообщением из очереди',
  'queue.steer.unavailable': 'Перебить можно только пока агент выполняется',
  ...
  'queue.steerFailed': 'Не удалось перебить. Повторите.',
