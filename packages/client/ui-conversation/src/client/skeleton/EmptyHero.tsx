...
/** Public URL of the Matreshka nesting-doll PNG used as the hero fallback. */
const MATRESHKA_LOGO_SRC = '/matreshka-logo.png'

/**
 * The hero nesting-doll mark (34px), static at rest. Hover CSS on the
 * hitbox wobbles it like a tumbler doll. Decorative — hidden from the
 * accessibility tree; reduced motion keeps the static image.
