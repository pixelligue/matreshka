...
export const ru: Record<TrajectoryKey, string> = {
  ...
  'timing.outputTokensUnavailable': 'Число выходных токенов недоступно',
  'timing.durationTooShort': 'Слишком короткая длительность',
  'timing.showLocalTime': 'Показать местное время',
  'timing.showUnixTimestamp': 'Показать Unix-метку',
  ...
  'timing.sessionTimestamps': 'Метки сессии',
  'timing.sessionTimestampsRunning': 'Метки сессии (выполняется)',
  ...
  'code.copyOutput': 'Копировать вывод',
  ...
  'details.resize': 'Изменить ширину сведений',
  'details.resizeTitle': 'Перетащите, чтобы изменить размер. Двойной щелчок сбрасывает.',
  ...
  'layout.compactionFailed': 'Сжатие контекста не удалось',
