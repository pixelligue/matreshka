...
export const ru = {
  ...
  presetSubtitle: 'Собираются пресетом агента для каждой сессии',
  countUnit: 'шт.',
  ...
  presetProvidedDetail: 'Глобально выключен; пресеты агента дают его в сессии',
  enabledIn: 'Включён в',
  viewInPreset: 'Смотреть в группе пресета',
