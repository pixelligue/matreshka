...
export const ru = {
  ...
  'description.compact': 'Сжать более раннюю историю диалога',
  'description.permission': 'Сменить пресет прав (песочница и политика подтверждений)',
  'description.export': 'Скачать журнал этой сессии как ZIP',
  'token.goal': 'цель',
  'token.plan': 'план',
