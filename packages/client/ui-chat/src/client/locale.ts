...
export const ru = {
  ...
  'stats.dialog.usageTitle': 'Расход токенов',
  ...
  'chat.deepDiving': 'Глубокий разбор…',
  ...
  'settings.transcript.description': 'Управляет процессом в завершённых ходах',
  ...
  'message.audio': 'Слушать {name}',
  'message.audioLoading': 'Загрузка аудио…',
  'message.audioFailed': 'Не удалось воспроизвести аудио',
  ...
  'message.contextRecall': 'Восстановление сессии',
  ...
  'message.turnError': 'Этот ход не удался',
  'message.maxTokens': 'Достигнут лимит выходных токенов',
  'message.maxTokens.hint': 'Ответ обрезан; предыдущий вывод сохранён в диалоге. Отправьте «continue», чтобы модель продолжила.',
  ...
  'message.turnUsage.reasoning': ' (рассуждение {tokens})',
...
export const zh = {
  ...
  'message.audio': '播放 {name}',
  'message.audioLoading': '正在加载音频…',
  'message.audioFailed': '无法播放这段音频',
...
export const en = {
  ...
  'message.audio': 'Play {name}',
  'message.audioLoading': 'Loading audio…',
  'message.audioFailed': 'This audio cannot be played',
