...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchDescription: 'The Matreshka web search provider.',
...
export const ru: Record<PluginsSettingsLocaleKey, string> = {
  ...
  readOnly: 'В этом развёртывании настройки только для чтения.',
  ...
  saveFailed: 'Развёртывание не приняло эти значения; их оставили, чтобы вы исправили.',
  invalidNumber: 'Введите число или оставьте пустым для значения по умолчанию.',
  bashTitle: 'Shell',
  bashDescription: 'Ограничения каждой команды, которую запускает агент.',
  ...
  bashMaxOutputBytesHint: 'Вывод сверх лимита уходит во временный файл, а не теряется.',
  agentLoopTitle: 'Цикл агента',
  agentLoopDescription: 'Как агент рассылает вызовы инструментов.',
  agentLoopMaxParallel: 'Параллельные вызовы инструментов',
  agentLoopMaxParallelHint: 'Верхняя граница безопасных параллельных вызовов в одном шаге.',
  webSearchTitle: 'Поиск в вебе',
  webSearchDescription: 'Провайдер веб-поиска Matreshka.',
  ...
  webSearchApiKeyUnset: 'Ключ не задан; поиск недоступен, пока его не укажут.',
  ...
  subagentModelSelectionDescription: 'Какие модели агенты могут выбирать для субагентов.',
  subagentModelSelectionToggle: 'Разрешить агентам выбирать модели для субагентов',
  subagentModelSelectionChoose: 'Если включено, агенты могут выбрать провайдера, модель и уровень рассуждения для каждого субагента из разрешённых ниже. Влияет только на новые сессии.',
  subagentModelSelectionAllowed: 'Модели, которые можно выбирать',
  ...
  subagentModelSelectionPartial: 'Некоторые провайдеры моделей не загрузились; сохранённые выборы всё ещё можно снять.',
  subagentModelSelectionUnavailable: 'Сейчас недоступно',
  subagentModelSelectionUnavailableGroup: 'Сохранено, но сейчас недоступно',
  subagentModelSelectionEmpty: 'Ни один провайдер сейчас не объявляет модель.',
  subagentModelSelectionRequired: 'Перед сохранением выберите хотя бы одну модель.',
  subagentModelSelectionConflict: 'Настройки изменили в другом месте. Отмените черновик и повторите.',
  subagentModelSelectionOff: 'Субагенты используют заданные умолчания или модель родительского агента. Сохранённый выбор моделей остаётся.',
}
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchTitle: '网页搜索',
  webSearchDescription: 'Matreshka 网页搜索提供方。',
  webSearchApiKey: 'API Key',
