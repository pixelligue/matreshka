...
export const ru: { [Key in keyof typeof en]: string } = {
  ...
  welcomeBody: 'DeepSeek Harness 0.1 всё ещё в тестировании для разработчиков Harness. Многое ещё нужно улучшить, и мы ждём отзывы сообщества. Базовые плагины и API DeepSeek Harness будут быстро меняться в ближайшие месяцы.\n\nМы хотим вместе с разработчиками исследовать пределы интеллекта на открытой, переиспользуемой и компонуемой инфраструктуре. Приглашаем разработчиков Harness в экосистему плагинов DSH.',
