...
import { en as conversationEn, NS as CONVERSATION_NS, ru as conversationRu, zh as conversationZh } from '@deepseek-ai/dsh-client-ui-conversation/src/client/locales.ts'
...
async function bench(snapshot: ChatSnapshot) {
  ...
  locale.register(CONVERSATION_NS, { zh: conversationZh, en: conversationEn, ru: conversationRu })
