...
export const en = {
  ...
  startupFailed: 'Matreshka could not start',
  startupLoading: 'Starting Matreshka…',
  ...
  pluginWindowTitle: 'Matreshka — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: 'Matreshka 无法启动',
  startupLoading: '正在启动 Matreshka…',
  ...
  pluginWindowTitle: 'Matreshka — 桌面插件',
